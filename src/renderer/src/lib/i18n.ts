...
const translations = {
  en: {
    ...
    "settings.proxy.description": "Configure application-level proxy behavior independently from model providers.",
    "settings.proxy.mode": "Mode",
    "settings.proxy.system": "System",
    "settings.proxy.manual": "Manual",
    "settings.proxy.disabled": "Disabled",
    "settings.proxy.mode_hint": "System uses existing environment variables. Manual uses the values below.",
