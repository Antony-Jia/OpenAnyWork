...
const translations = {
  en: {
    ...
    "skills.path": "Path",
    "skills.sources_hint": "Sources: .openwork/skills + .openwork/agent/skills + agent/skills",
    "skills.source": "Source",
    "skills.source_managed": "Managed (.openwork/skills)",
    "skills.source_agent_user": "Agent User (~/.openwork/agent/skills)",
    "skills.source_agent_workspace": "Agent Workspace (agent/skills)",
  ...
  zh: {
    ...
    "skills.path": "路径",
    "skills.sources_hint": "来源：.openwork/skills + .openwork/agent/skills + agent/skills",
    "skills.source": "来源",
    "skills.source_managed": "托管目录（.openwork/skills）",
    "skills.source_agent_user": "Agent用户目录（~/.openwork/agent/skills）",
    "skills.source_agent_workspace": "Agent工作区目录（agent/skills）",
