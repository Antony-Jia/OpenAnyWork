...
const translations = {
  en: {
    ...
    "settings.qq.title": "QQ",
    "settings.qq.enabled": "Enable QQ Bot",
    "settings.qq.app_id": "App ID",
    "settings.qq.client_secret": "Client Secret",
    "settings.proxy.title": "PROXY",
    "settings.proxy.description":
      "Configure application-level proxy behavior independently from model providers.",
    "settings.proxy.mode": "Mode",
    "settings.proxy.system": "System",
    "settings.proxy.manual": "Manual",
    "settings.proxy.disabled": "Disabled",
    "settings.proxy.mode_hint":
      "System uses existing environment variables. Manual uses the values below.",
    "settings.proxy.http_proxy": "HTTP Proxy",
    "settings.proxy.https_proxy": "HTTPS Proxy",
    "settings.proxy.no_proxy": "No Proxy",
    ...
    "provider.url_placeholder_openai_native": "https://api.openai.com/v1",
    "provider.url_placeholder_ark": "https://ark.cn-beijing.volces.com/api/v3",
    "provider.url_placeholder_openrouter": "https://openrouter.ai/api/v1",
    ...
    "provider.model_placeholder_openai_native": "e.g. gpt-5 or o4-mini",
    "provider.model_placeholder_ark": "e.g. doubao-seed-2-0-lite-250821",
    "provider.model_placeholder_openrouter": "e.g. z-ai/glm-5.1",
    "provider.model_placeholder_multimodal": "e.g. gpt-4o",
    "provider.key_placeholder": "sk-...",
    "provider.implementation": "Implementation",
    "provider.implementation.openai_native": "OpenAI Native",
    "provider.implementation.ark": "ByteDance Ark",
    "provider.implementation.openrouter": "OpenRouter",
    "provider.api_key_hint_openai_native": "Use an OpenAI API key for the selected model.",
    "provider.api_key_hint_ark": "Use your ARK API key from Volcengine.",
    "provider.api_key_hint_openrouter": "Use your OpenRouter API key.",
    "provider.reasoning_enabled": "Enable reasoning",
    "provider.reasoning_effort": "Reasoning effort",
    "provider.reasoning_effort.low": "Low",
    "provider.reasoning_effort.medium": "Medium",
    "provider.reasoning_effort.high": "High",
    ...
    "skills.tab_installed": "Installed Skills",
    "skills.tab_packages": "Package Skills",
    ...
    "skills.file_path": "File Path",
    "skills.file_path_hint": "e.g. REFERENCE.md or scripts/example.py",
    "skills.add_file": "Add File",
    "skills.files": "Files",
    "skills.quick_add_reference": "Add REFERENCE.md",
    "skills.quick_add_script": "Add scripts/example.py",
    "skills.remove_file": "Remove File",
    "skills.text_file": "Text",
    "skills.binary_file": "Binary",
    "skills.file_editable": "Editable text file",
    "skills.file_readonly": "Read-only text file",
    "skills.binary_hint": "Binary files are listed but cannot be edited inline in v1.",
    "skills.save": "Save",
    "skills.cancel": "Cancel",
    "skills.edit": "Edit",
    "skills.delete": "Delete",
    "skills.remove_cli": "Remove via CLI",
    "skills.disabled_hint": "Disabled skills are not injected into agents.",
    "skills.package_source": "Source URL / Repo / Local Path",
    "skills.package_source_hint": "GitHub URL, owner/repo, repo subpath URL, or local path",
    "skills.package_names": "Specific Skills (optional)",
    "skills.package_names_hint": "One per line or comma-separated",
    "skills.find_query": "Find Query",
    "skills.find_hint": "Keyword search only",
    "skills.remove_names": "Skills to Remove",
    "skills.remove_names_hint": "One per line or comma-separated",
    "skills.init_name": "New Skill Name",
    "skills.cli_add": "npx skills add",
    "skills.cli_list": "npx skills list",
    "skills.cli_find": "npx skills find",
    "skills.cli_remove": "npx skills remove",
    "skills.cli_check": "npx skills check",
    "skills.cli_update": "npx skills update",
    "skills.cli_init": "npx skills init",
    "skills.package_output": "CLI Output",
    "skills.package_command": "Command",
    "skills.package_empty_output": "(empty)",
    "skills.package_output_hint": "Run a package command to inspect normalized stdout and stderr.",
    ...
    "plugin.actionbook.manual_mode_hint":
      "Default mode is Isolated. Use Extension only when you need your existing Chrome session.",
    "plugin.actionbook.setup_hint":
      "Run `actionbook setup` first. In current versions, the extension bridge starts automatically during browser commands; `actionbook extension serve` is mainly for debugging.",
    ...
    "plugin.actionbook.extension_path": "Extension path",
    "plugin.actionbook.extension_version": "Extension version",
  ...
  zh: {
    ...
    "settings.qq.title": "QQ",
    "settings.qq.enabled": "启用 QQ Bot",
    "settings.qq.app_id": "App ID",
    "settings.qq.client_secret": "Client Secret",
    "settings.proxy.title": "代理",
    "settings.proxy.description": "独立配置应用级代理，不依赖模型提供者设置。",
    "settings.proxy.mode": "模式",
    "settings.proxy.system": "系统",
    "settings.proxy.manual": "手动",
    "settings.proxy.disabled": "禁用",
    "settings.proxy.mode_hint": "系统模式读取当前环境变量；手动模式使用下方填写的值。",
    "settings.proxy.http_proxy": "HTTP 代理",
    "settings.proxy.https_proxy": "HTTPS 代理",
    "settings.proxy.no_proxy": "绕过代理地址",
    ...
    "provider.model_placeholder_openai_native": "如 gpt-5 或 o4-mini",
    "provider.model_placeholder_ark": "如 doubao-seed-2-0-lite-250821",
    "provider.model_placeholder_openrouter": "如 z-ai/glm-5.1",
    "provider.model_placeholder_multimodal": "如 gpt-4o",
    "provider.key_placeholder": "sk-...",
    "provider.implementation": "实现类型",
    "provider.implementation.openai_native": "OpenAI 原生推理",
    "provider.implementation.ark": "字节 Ark 推理",
    "provider.implementation.openrouter": "OpenRouter 兼容推理",
    "provider.api_key_hint_openai_native": "使用 OpenAI 官方 API Key。",
    "provider.api_key_hint_ark": "使用火山引擎 ARK API Key。",
    "provider.api_key_hint_openrouter": "使用 OpenRouter API Key。",
    "provider.reasoning_enabled": "启用推理",
    "provider.reasoning_effort": "推理强度",
    "provider.reasoning_effort.low": "低",
    "provider.reasoning_effort.medium": "中",
    "provider.reasoning_effort.high": "高",
    "provider.active": "已激活",
    ...
    "skills.create": "创建技能",
    "skills.install": "路径安装",
    "skills.tab_installed": "已安装技能",
    "skills.tab_packages": "技能包管理",
    "skills.empty": "暂无技能",
    "skills.name": "名称",
    ...
    "skills.file_path": "文件路径",
    "skills.file_path_hint": "例如 REFERENCE.md 或 scripts/example.py",
    "skills.add_file": "新增文件",
    "skills.files": "文件列表",
    "skills.quick_add_reference": "添加 REFERENCE.md",
    "skills.quick_add_script": "添加 scripts/example.py",
    "skills.remove_file": "移除文件",
    "skills.text_file": "文本",
    "skills.binary_file": "二进制",
    "skills.file_editable": "可编辑文本文件",
    "skills.file_readonly": "只读文本文件",
    "skills.binary_hint": "v1 仅列出二进制文件，不支持内联编辑。",
    "skills.save": "保存",
    "skills.cancel": "取消",
    "skills.edit": "编辑",
    "skills.delete": "删除",
    "skills.remove_cli": "通过 CLI 移除",
    "skills.disabled_hint": "已禁用的技能不会注入到智能体。",
    "skills.package_source": "来源 URL / 仓库 / 本地路径",
    "skills.package_source_hint": "支持 GitHub URL、owner/repo、仓库子路径 URL 或本地路径",
    "skills.package_names": "指定技能（可选）",
    "skills.package_names_hint": "每行一个或逗号分隔",
    "skills.find_query": "搜索关键词",
    "skills.find_hint": "仅支持关键词搜索",
    "skills.remove_names": "要移除的技能",
    "skills.remove_names_hint": "每行一个或逗号分隔",
    "skills.init_name": "新技能名称",
    "skills.cli_add": "npx skills add",
    "skills.cli_list": "npx skills list",
    "skills.cli_find": "npx skills find",
    "skills.cli_remove": "npx skills remove",
    ...
    "skills.cli_update": "npx skills update",
    "skills.cli_init": "npx skills init",
    "skills.package_output": "CLI 输出",
    "skills.package_command": "执行命令",
    "skills.package_empty_output": "（空）",
    "skills.package_output_hint": "执行一个技能包命令后，这里会显示规范化后的 stdout 和 stderr。",
    ...
    "plugin.actionbook.manual_mode_hint":
      "默认模式是 Isolated。只有在需要复用现有 Chrome 登录态时才使用 Extension。",
    "plugin.actionbook.setup_hint":
      "建议先执行 `actionbook setup`。当前版本会在浏览器命令执行时自动拉起扩展 bridge，`actionbook extension serve` 主要用于调试。",
    "plugin.actionbook.enabled": "启用",
    "plugin.actionbook.check_cli": "CLI",
    "plugin.actionbook.check_skill": "Skill",
    "plugin.actionbook.check_extension": "扩展",
    "plugin.actionbook.extension_path": "扩展路径",
    "plugin.actionbook.extension_version": "扩展版本",
