...
export function buildEmailModePromptForThread(threadId: string): string {
  return [
...
export function buildEmailModePrompt(context: AgentPromptContext): string {
  return buildEmailModePromptForThread(context.threadId)
}
